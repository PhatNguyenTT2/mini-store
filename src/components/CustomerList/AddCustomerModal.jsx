  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const customerData = {
        ...
        totalSpent: 0, // Default value for new customers
        totalPurchases: 0, // Default value
      ...
      setError(err.response?.data?.error || err.error || err.message || 'Failed to create customer. Please try again.');
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[10000]">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-3xl max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          {/* Row 4: Customer Type & Total Spent */}
          <div className="grid grid-cols-2 gap-4">
            {/* Customer Type */}
            <div>
              <label className="block text-[13px] font-medium font-['Poppins',sans-serif] text-[#212529] mb-2">
            ...
            <div>
              ...
              />
              <p className="mt-1 text-[11px] text-gray-500 font-['Poppins',sans-serif]">
                Will be updated automatically with purchases
              </p>
            </div>
          </div>
